...
- **Видалення акаунту нічого не видаляє.** Запит і скасування працюють, але
  завдання, яке після 30 днів стирає акаунт, ще не написане — рядки просто
  накопичуються зі спливлим `scheduled_for`. Безпечний бік помилки, але
  тимчасовий; потребує рішення щодо анонімізованого сліду і runbook.
