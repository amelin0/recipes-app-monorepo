...
**Останнє оновлення:** 2026-09-07 — зріз 10 (план харчування) закрито,
...
- **`client/shopping-list`** — дві специфікації, і план уже його чекає:
  FR-006 (кошик на страві й «Додати до списку покупок») не побудовано саме
...
| `pnpm --filter @dns/validation test`         | 48 — плюс каталог, власна страва, вікно плану і справжність календарної дати         |
...
| `pnpm --filter @dns/client-api test:db`      | 135 — auth, user, nutrition, анкета, прогрес, каталог і план (треба docker)          |
