...
Admin panel authentication: login with ADMIN / SUPER_ADMIN role check (authMiddleware + adminMiddleware).
...
|---|---|---|---|
| [Sign in (Вхід в адмінпанель)](./sign-in/spec.md) | Implemented | @amelin0 | 2026-09-07 |
