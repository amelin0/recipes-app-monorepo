...
| ------------------------------------------------------------------------ | ----------- | ---------------------------------- | -------- | ---------- |
| [Profile (Профіль і налаштування)](./profile/spec.md)                    | Implemented | [plan](./profile/plan.md)          | @amelin0 | 2026-09-11 |
| [Profile edit (Редагування профілю)](./profile-edit/spec.md)             | Implemented | [plan](./profile-edit/plan.md)     | @amelin0 | 2026-09-11 |
...
- Код (API): `apps/client-api/src/modules/user/`
