...
- [`components`](../components/SKILL.md) — atomic component conventions
- [`widgets`](../widgets/SKILL.md) — composed component patterns
- [`screens`](../screens/SKILL.md) — screen-level a11y (focus order, labels)
- [`styles`](../styles/SKILL.md) — token system + dark mode (which a11y depends on)
- [`localization`](../localization/SKILL.md) — accessibility labels through i18n
