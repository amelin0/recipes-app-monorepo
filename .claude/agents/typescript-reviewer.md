...
3. Run the project's canonical TypeScript check first: this repo uses `pnpm typecheck` (workspace-wide) or `pnpm --filter @dns/mobile typecheck` for mobile only. If you need to scope tighter, run `tsc --noEmit -p apps/mobile/tsconfig.json`. Never run in build mode.
...
pnpm --filter @dns/mobile typecheck        # mobile-only
pnpm lint                                    # all packages
pnpm format                                  # Prettier write
pnpm audit                                   # dependency vulnerabilities
pnpm --filter @dns/mobile test:e2e          # Maestro E2E suite
```
...
For project-specific patterns, consult these skills before reviewing:
- [`apps/mobile/.claude/skills/architecture`](../skills/architecture/SKILL.md) — layered architecture & module boundaries
- [`apps/mobile/.claude/skills/naming-conventions`](../skills/naming-conventions/SKILL.md) — file + symbol naming
- [`apps/mobile/.claude/skills/state-management`](../skills/state-management/SKILL.md) — Zustand + TanStack Query patterns
- [`apps/mobile/.claude/skills/data-layer`](../skills/data-layer/SKILL.md) — API/MMKV/SecureStore conventions
- [`apps/mobile/.claude/skills/screens`](../skills/screens/SKILL.md) — View + Hook pattern
- [`apps/mobile/.claude/skills/styles`](../skills/styles/SKILL.md) — Uniwind Pro / Tailwind v4 rules
